...
class Head(nn.Module):
    def __init__(self, input_channels, output_channels):
        ...
        self.conv5x5 = nn.Sequential(
            nn.Conv2d(input_channels, input_channels, 5, 1,
                      2, groups=input_channels, bias=False),
...
class SPP(nn.Module):
    def __init__(self, input_channels, output_channels):
        ...
        self.S1 = nn.Sequential(
            nn.Conv2d(output_channels, output_channels, 5, 1,
                      2, groups=output_channels, bias=False),
            nn.BatchNorm2d(output_channels),
            nn.ReLU(inplace=True)
        )
