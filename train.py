...
class FastestDet:
    def __init__(self):
        ...
        parser.add_argument('--weight', type=str, default="checkpoints/weight_AP05_0.7004_200.pth", help='.weight config')
        ...
        train_dataset = TensorDataset(
            self.cfg.train_txt, self.cfg.input_width, self.cfg.input_height, 10, True)
    ...
    def train(self):
        ...
        for epoch in range(self.cfg.end_epoch + 1):
            ...
            if epoch % 10 == 0 and epoch > 0:
                ...
                mAP05 = round(mAP05, 4)
                torch.save(self.model.state_dict(), "checkpoints/weight_AP05_{:.4f}_{}.pth".format(mAP05, epoch))
